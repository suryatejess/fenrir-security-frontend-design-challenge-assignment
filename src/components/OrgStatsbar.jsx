      ...
      <div className="flex items-center justify-between pb-4 border-b border-gray-100 text-sm">
        <div className="flex items-center gap-8">
          <div className="flex items-center gap-2">
            ...
            <span className="font-medium text-gray-900">{orgInfo.org}</span>
          </div>
          <div className="flex items-center gap-2">
            <span className="text-gray-500">Owner:</span>
            <span className="font-medium text-gray-900">{orgInfo.owner}</span>
          </div>
          <div className="flex items-center gap-2">
            <span className="text-gray-500">Total Scans:</span>
            <span className="font-medium text-gray-900">{orgInfo.totalScans}</span>
          </div>
          <div className="flex items-center gap-2">
            <span className="text-gray-500">Scheduled:</span>
            <span className="font-medium text-gray-900">{orgInfo.scheduled}</span>
          </div>
          <div className="flex items-center gap-2">
            <span className="text-gray-500">Rescans:</span>
            <span className="font-medium text-gray-900">{orgInfo.rescans}</span>
          </div>
          <div className="flex items-center gap-2">
            <span className="text-gray-500">Failed Scans:</span>
            <span className="font-medium text-gray-900">{orgInfo.failedScans}</span>
          </div>
        </div>
